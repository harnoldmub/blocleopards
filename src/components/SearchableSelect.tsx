    ...
    <div ref={rootRef} style={{ position: "relative", minWidth }}>
      <button type="button" onClick={() => setOpen(o => !o)}
        style={{
          ...
          minHeight: 40,
          background: isActive
            ? "linear-gradient(180deg, rgba(247,214,24,0.14), rgba(247,214,24,0.06))"
            : "linear-gradient(180deg, rgba(255,255,255,0.065), rgba(255,255,255,0.035))",
          border: `1px solid ${isActive ? "rgba(247,214,24,0.42)" : open ? "rgba(96,165,250,0.36)" : "rgba(96,165,250,0.18)"}`,
          borderRadius: 10, padding: "9px 12px", color: isActive ? C.yellow : C.text,
          ...
          boxShadow: open ? "0 0 0 4px rgba(96,165,250,0.08)" : "inset 0 1px 0 rgba(255,255,255,0.04), 0 14px 28px -26px rgba(0,0,0,0.8)",
        }}>
      ...
      {open && (
        <div style={{
          ...
          background: "linear-gradient(180deg, #111827, #0d1117)", border: `1px solid rgba(96,165,250,0.2)`, borderRadius: 12,
          boxShadow: "0 18px 48px rgba(0,0,0,0.55)", overflow: "hidden",
        }}>
          <div style={{ padding: 8, borderBottom: `1px solid rgba(96,165,250,0.14)` }}>
            <div style={{ position: "relative" }}>
              ...
              <input ref={inputRef} value={query} onChange={e => setQuery(e.target.value)} onKeyDown={onInputKey}
                ...
                style={{
                  width: "100%", background: "rgba(255,255,255,0.06)", border: `1px solid rgba(96,165,250,0.18)`,
                  borderRadius: 8, padding: "7px 10px 7px 30px", color: C.text, fontSize: 12,
                  fontFamily: "'Sora', sans-serif", outline: "none", boxShadow: "inset 0 1px 0 rgba(255,255,255,0.04)",
                }} />
            </div>
          </div>
